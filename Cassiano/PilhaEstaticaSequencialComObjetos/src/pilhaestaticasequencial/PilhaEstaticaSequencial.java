...
public class PilhaEstaticaSequencial {
    ...
    public void simulacaoLeituraDeDados() {
        // Para efetuar teste rápido, criamos uma pilha com dados fixos:
        p = new Pilha();
    ...
    public void leituraDeDados() {
        ...
        p = new Pilha(); // A alocação de memória agora é dinâmica
        for (int i = 0; i < N; i++) {
            ...
            p.push(new Trabalhador(umNome, umSalario, umSexo)); // Adiciona o trabalhador à pilha
        }
    }
}
